function varargout=shadedErrorBar(plotX,plotY,errBar)
...
%             the data line. e.g.:    
%             'ob-', or {'-or','markerfacecolor',[1,0.2,0.2]}
...
H.mainLine=plot(plotX,plotY,lineProps{:});
...
H.edge(1)=plot(plotX,lE,'-','color',edgeColor);
H.edge(2)=plot(plotX,uE,'-','color',edgeColor);
